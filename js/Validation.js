...
//    if(document.getElementsByName("values[people][PRIMARY][FIRST_NAME]")[0] && document.getElementsByName("values[people][PRIMARY][FIRST_NAME]")[0].value!='')
//    {
//        var k=1;
//    }
//
//    if(document.getElementsByName("values[people][PRIMARY][LAST_NAME]")[0] && document.getElementsByName("values[people][PRIMARY][LAST_NAME]")[0].value!='')
//    {
//        var l=1;
//    }
//     if(document.getElementsByName("values[people][PRIMARY][EMAIL]")[0] && document.getElementsByName("values[people][PRIMARY][EMAIL]")[0].value!='')
//    {
//        var e=1;
//    }
//    

// alert('if('+document.getElementsByName("values[people][SECONDARY][RELATIONSHIP]")[0].value+'== && '+document.getElementsByName("values[people][SECONDARY][FIRST_NAME]")[0].value+'== && '+document.getElementsByName("values[people][SECONDARY][LAST_NAME]")[0].value+'== && '+document.getElementsByName("values[people][SECONDARY][HOME_PHONE]")[0].value+'== && '+document.getElementsByName("values[people][SECONDARY][WORK_PHONE]")[0].value+'==  && '+document.getElementsByName("values[people][SECONDARY][CELL_PHONE]")[0].value+'==  && '+document.getElementsByName("values[people][SECONDARY][EMAIL]")[0].value+'==  && '+custody+'==n  && '+document.getElementsByName("secondary_portal")[0].checked+'==false && ('+typeof k +'=== object || '+k+'==1) && ('+typeof l +'=== object || '+l+'==1) && ('+typeof c +'=== object || '+c+'==1) && ('+typeof e+' === object || '+e+'==1))');
