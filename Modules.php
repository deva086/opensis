...
require('Menu.php');
echo "<li><a style='cursor:hand;' href='#' onmouseup='check_content(\"Ajax.php?modname=miscellaneous/Portal.php\");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \""._('Home')."\";document.getElementById(\"cframe\").src = \"Bottom.php?modcat=home\"'><span>" .""._('Home')."". "</span></a></li>";
...
//echo User('PROFILE');
	if(count($_openSIS['Menu'][$modcat]))
	{
		...
		if(!$menu)
			continue;
// \""._(str_replace('_',' ',$modcat))."\"

		if(User('PROFILE')!='admin' && $modcat=="schoolsetup")
		{

			echo "<li><a style='cursor:hand;' HREF=# onmouseup='check_content(\"Ajax.php?modname=$modcat/Search.php\");' target=body onmousedown='document.getElementById(\"header\").innerHTML =\""._('School Info')."\";document.getElementById(\"cframe\").src = \"Bottom.php?modcat=".$modcat."\"'><span>"._('School Info')."</span></a></li>";
		}
                
		elseif(User('PROFILE')!='admin' && $modcat=="users")
		{
			echo "<li><a style='cursor:hand;' HREF=# onmouseup='check_content(\"Ajax.php?modname=$modcat/Search.php\");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \""._('My Info')."\";document.getElementById(\"cframe\").src = \"Bottom.php?modcat=".$modcat."\"'><span>"._('My Info')."</span></a></li>";
		}
		...
		{
			echo "<li><a style='cursor:hand;' HREF=# onmouseup='check_content(\"Ajax.php?modname=$modcat/Search.php\");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \""._(ucwords(str_replace('_',' ',$modcat)))."\";document.getElementById(\"cframe\").src = \"Bottom.php?modcat=".$modcat."\"'><span>"._('Schedule')."</span></a></li>";
		}
                 elseif($modcat=="messaging")
                {                   
                        echo "<li><a style='cursor:hand;' HREF=# onmouseup='check_content(\"Ajax.php?modname=$modcat/Inbox.php\");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \""._(ucwords(str_replace('_',' ',$modcat)))."\";document.getElementById(\"cframe\").src = \"Bottom.php?modcat=".$modcat."\"'><span>"._('Messaging')."</span></a></li>";
                }
		else
		{
                        ...
                        echo "<li><a style='cursor:hand;' HREF=# onmouseup='check_content(\"Ajax.php?modname=$modcat/Search.php\");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \""._('Extracurricular')."\";document.getElementById(\"cframe\").src = \"Bottom.php?modcat=".$modcat."\"'><span>"._('Extracurricular')."</span></a></li>";    
                        }
                        elseif($modcat=='schoolsetup')
                        echo "<li><a style='cursor:hand;' HREF=# onmouseup='check_content(\"Ajax.php?modname=$modcat/Search.php\");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \""._('School Setup')."\";document.getElementById(\"cframe\").src = \"Bottom.php?modcat=".$modcat."\"'><span>"._('School Setup')."</span></a></li>";

                        else
                        {
			echo "<li><a style='cursor:hand;' HREF=# onmouseup='check_content(\"Ajax.php?modname=$modcat/Search.php\");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \"".(ucwords(str_replace('_',' ',$modcat)))."\";document.getElementById(\"cframe\").src = \"Bottom.php?modcat=".$modcat."\"'><span>"._(ucfirst(str_replace('_',' ',$modcat)))."</span></a></li>";
                        }
...
echo "<div id='submenu_".$i."' style='display:none'>"; 
		...
		foreach($keys as $key_index=>$file)
		{
			...
			elseif(!is_numeric($file))
				...
				echo "<A ".$style." id=hm HREF=# onClick='check_content(\"Ajax.php?modname=".$file." \");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \""._(ucwords($modcat))." >> "._($title)."\"' onmouseup=\"changeColors(); this.className='submenu_link'; document.getElementById('cframe').src='Bottom.php?modname=".$file."';\">"._('My Information')."</A> &nbsp;&nbsp;|&nbsp;&nbsp;";	
				}
				elseif(User('PROFILE')=='student' && $title=="Schedule"){
				echo "<A ".$style." id=hm HREF=# onClick='check_content(\"Ajax.php?modname=".$file." \");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \""._(ucwords($modcat))." >> "._($title)."\"' onmouseup=\"changeColors(); this.className='submenu_link'; document.getElementById('cframe').src='Bottom.php?modname=".$file."';\">"._('My Schedule')."</A> &nbsp;&nbsp;|&nbsp;&nbsp;";	
				}				
				elseif(User('PROFILE')=='student' && $title=="Student Requests"){
				echo "<A ".$style." id=hm HREF=# onClick='check_content(\"Ajax.php?modname=".$file." \");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \""._(ucwords($modcat))." >> "._($title)."\"' onmouseup=\"changeColors(); this.className='submenu_link'; document.getElementById('cframe').src='Bottom.php?modname=".$file."';\">"._('My Requests')."</A> &nbsp;&nbsp;|&nbsp;&nbsp;";	
				}
				else
				{

                                    if($modcat=='eligibility')
                                        echo "<A ".$style." id=hm HREF=# onClick='check_content(\"Ajax.php?modname=".$file." \");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \"Extracurricular >> "._($title)."\"' onmouseup=\"changeColors(); this.className='submenu_link'; document.getElementById('cframe').src='Bottom.php?modname=".str_replace('&', '?',$file)."';\">"._($title)."</A> &nbsp;&nbsp;|&nbsp;&nbsp;";    
                                    else
                                    {
                                        if(User('PROFILE_ID')!=0 && User('PROFILE')=='admin')
                                        {
                                            if($modcat=='tools' && $title!='Backup Database')
                                                echo "<A ".$style." id=hm HREF=# onClick='check_content(\"Ajax.php?modname=".$file." \");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \""._(ucwords($modcat))." >> "._($title)."\"' onmouseup=\"changeColors(); this.className='submenu_link'; document.getElementById('cframe').src='Bottom.php?modname=".str_replace('&', '?',$file)."';\">"._($title)."</A> &nbsp;&nbsp;|&nbsp;&nbsp;";
                                            if($modcat!='tools')
                                                echo "<A ".$style." id=hm HREF=# onClick='check_content(\"Ajax.php?modname=".$file." \");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \""._($modcat=='schoolsetup'?'School Setup':  ucwords($modcat))." >> "._($title)."\"' onmouseup=\"changeColors(); this.className='submenu_link'; document.getElementById('cframe').src='Bottom.php?modname=".str_replace('&', '?',$file)."';\">"._($title)."</A> &nbsp;&nbsp;|&nbsp;&nbsp;";
                                        }
                                        else
                                            echo "<A ".$style." id=hm HREF=# onClick='check_content(\"Ajax.php?modname=".$file." \");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \""._($modcat=='schoolsetup'?'School Setup':  ucwords($modcat))." >> "."$title\"' onmouseup=\"changeColors(); this.className='submenu_link'; document.getElementById('cframe').src='Bottom.php?modname=".str_replace('&', '?',$file)."';\">"._($title)."</A> &nbsp;&nbsp;|&nbsp;&nbsp;";
                                    }
				}
			elseif($keys[$key_index+1] && !is_numeric($keys[$key_index+1]))
			{
                            ...
                            if(User('PROFILE_ID')!=0 && User('PROFILE')=='admin')
                            {
                                if($modcat=='tools' &&  $title!='Reports')
                                    echo '<label class="dd_menuitem" id="mm_'.$modcat.'_'.$mm.'"><b>'._($title).'</b>&nbsp;<img src="themes/'.trim(strtolower ($css)).'/mnu_drpdwn.gif" />&nbsp;&nbsp;|&nbsp;&nbsp;</label>&nbsp;'.'<div id="menu_child_'.$modcat.'_'.$mm.'" style="position: absolute; visibility: hidden; width:200px;">';
			...
			elseif(!is_numeric($file))
                        {
                                if($modcat=='eligibility')
                                echo "<A id=dd class='dd_submenuitem' HREF=# onClick='check_content(\"Ajax.php?modname=".$file." \");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \"Extracurricular >> "._($title)."\"' onmouseup=\"document.getElementById('cframe').src='Bottom.php?modname=".$file."';\">"._($title)."</A>";
                                else
                                {
                                        ...
                                        if(User('PROFILE_ID')!=0 && User('PROFILE')=='admin')
                                        {
                                            if($modcat=='tools' && $title!='At a Glance' && $title!='Institute Reports' && $title!='Institute Custom Field Reports')
                                                echo "<A id=dd class='dd_submenuitem' HREF=# onClick='check_content(\"Ajax.php?modname=".$file." \");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \"". ucwords($modcat)." >> "._($title)."\"' onmouseup=\"document.getElementById('cframe').src='Bottom.php?modname=".$file."';\">"._($title)."</A>";
//                                            
                                            if($modcat!='tools')
                                            {
                                                
                                                echo "<A id=dd class='dd_submenuitem' HREF=# onClick='check_content(\"Ajax.php?modname=".$file." \");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \""._($modcat=='schoolsetup'?'School Setup':  ucwords($modcat))." >> "._($title)."\"' onmouseup=\"document.getElementById('cframe').src='Bottom.php?modname=".$file."';\">"._($title)."</A>";
                                            }
                                                }
                                        else
                                            echo "<A id=dd class='dd_submenuitem' HREF=# onClick='check_content(\"Ajax.php?modname=".$file." \");' target=body onmousedown='document.getElementById(\"header\").innerHTML = \""._($modcat=='schoolsetup'?'School Setup':  ucwords($modcat))." >> "._($title)."\"' onmouseup=\"document.getElementById('cframe').src='Bottom.php?modname=".$file."';\">"._($title)."</A>";
			...
			{
			 $mm=$mm+1;
			echo '</div><label class="dd_menuitem" id="mm_'.$modcat.'_'.$mm.'"><b>'._($title).'</b>&nbsp;<img src="themes/'.trim(strtolower ($css)).'/mnu_drpdwn.gif" />&nbsp;&nbsp;|&nbsp;&nbsp;</label>'.'<div id="menu_child_'.$modcat.'_'.$mm.'" style="position: absolute; visibility: hidden; width=200px;">';
			}
...
echo "</div>";
  ...
  <tr>
    <td align='center' class='copyright'>
       <center>"._('openSIS is a product of Open Solutions for Education, Inc. ')." (<a href='http://www.os4ed.com' target='_blank'>"._('OS4Ed')."</a>)."._('and is licensed under the')."<a href='http://www.gnu.org/licenses/gpl.html' target='_blank'>"._('GPL License')."</a>.
                </center></td>
  </tr>
</table>
			</td>
